...
const en = {
  ...
  'account.localProvider': 'Local dev',
  'account.noProviders': 'No linked providers.',
  'account.otherSessionsRevoked': 'Other active sessions were signed out.',
  ...
  'account.revokeOthers': 'Sign out others',
  'account.revoked': 'Revoked',
  'account.saveProfile': 'Save profile',
  'account.savingProfile': 'Saving...',
  'account.session': 'Session',
  'account.sessions': 'Sessions',
  'account.sessionsUnavailable': 'Sessions could not be loaded.',
  'account.sessionsUpdateFailed': 'Sessions could not be updated.',
  'account.title': 'Account',
  'aria.executionStatus': 'Execution status',
  'aria.toolInput': 'Tool input',
  'aria.tools': 'Tools',
  'auth.dialogSubtitle': 'Choose how to connect your workspace.',
  'auth.dialogTitle': 'Sign in',
  'auth.emailReserved': 'Email magic links are reserved for a later release.',
  'auth.githubLogin': 'Continue with GitHub',
  'auth.githubUnavailable': 'GitHub login is not configured',
  'auth.localDevLogin': 'Continue as Local User',
  'auth.noProvider': 'No login provider is available in this environment.',
  'auth.optionsUnavailable': 'Login options could not be loaded.',
  'auth.signIn': 'Sign in',
  ...
  'command.toggleStyle': 'Toggle visual style',
  ...
  'style.island': 'Island',
  'style.switchToDefault': 'Switch to current style',
  'style.switchToIsland': 'Switch to Animal Crossing style',
  'tabs.error': 'Error',
  'tabs.raw': 'Raw',
  'tabs.tree': 'Tree',
  'tags.all': 'All',
...
const zh: Record<MessageKey, string> = {
  ...
  'actions.sample': '示例',
  'account.active': '有效',
  'account.activeSessions': '有效会话',
  'account.avatarUrl': '头像 URL',
  'account.currentSession': '当前会话',
  'account.displayName': '显示名称',
  'account.favorites': '收藏',
  'account.history': '历史',
  'account.localProvider': '本地开发',
  'account.noProviders': '还没有绑定的登录方式。',
  'account.otherSessionsRevoked': '其他有效会话已退出。',
  'account.profile': '个人资料',
  'account.profileSaveFailed': '无法保存资料。',
  'account.profileSaved': '资料已保存。',
  'account.providers': '登录方式',
  'account.revokeOthers': '退出其他设备',
  'account.revoked': '已撤销',
  'account.saveProfile': '保存资料',
  'account.savingProfile': '保存中...',
  'account.session': '会话',
  'account.sessions': '会话管理',
  'account.sessionsUnavailable': '无法加载会话。',
  'account.sessionsUpdateFailed': '无法更新会话。',
  'account.title': '账号',
  'aria.executionStatus': '执行状态',
  'aria.toolInput': '工具输入',
  'aria.tools': '工具',
  'auth.dialogSubtitle': '选择连接当前工作区的方式。',
  'auth.dialogTitle': '登录',
  'auth.emailReserved': '邮箱魔法链接将在后续版本开放。',
  'auth.githubLogin': '使用 GitHub 登录',
  'auth.githubUnavailable': 'GitHub 登录未配置',
  'auth.localDevLogin': '以本地用户继续',
  'auth.noProvider': '当前环境没有可用的登录方式。',
  'auth.optionsUnavailable': '无法加载登录方式。',
  'auth.signIn': '登录',
  ...
  'style.default': '当前',
  'style.island': '动森',
  'style.switchToDefault': '切换到当前风格',
  'style.switchToIsland': '切换到动森风格',
  'tabs.error': '错误',
  'tabs.raw': '原始',
  'tabs.tree': '树形',
  'tags.all': '全部',
